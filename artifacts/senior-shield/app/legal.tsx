...
const PAGES: Record<string, { title: string; icon: any; content: string[] }> = {
  privacy: {
    ...
    content: [
      ...
      "GoldenPeer (\u201cwe\u201d, \u201cour\u201d, \u201cus\u201d) is committed to protecting the privacy of our users, particularly seniors aged 65 and older. This Privacy Policy explains how we collect, use, store, and safeguard your personal information in compliance with applicable regulations including the General Data Protection Regulation (GDPR), the California Consumer Privacy Act (CCPA), and the Americans with Disabilities Act (ADA).",
      ...
      "Audit Logging:",
      "GoldenPeer maintains comprehensive audit logs of all account activity, including logins, profile changes, data access, and security-related events. These logs are used to detect unauthorized access, investigate security incidents, and maintain the integrity of your account. Audit logs are retained for 90 days and are accessible only by authorized security personnel.",
      ...
      "GoldenPeer is designed with accessibility as a core principle. We comply with ADA guidelines by offering: adjustable text sizes (Normal, Large, Extra Large); high-contrast display mode for users with visual impairments; voice-first interaction so the app can be used without reading the screen; simple, jargon-free language throughout the interface; large, easy-to-tap touch targets for all interactive elements.",
      "Data Retention:",
      ...
      "GoldenPeer uses the following third-party services: OpenAI for AI-powered voice assistance and scam detection; Stripe for secure payment processing (Pro plan); Resend for transactional emails (verification codes). These providers are contractually bound to protect your data and process it only as instructed by us.",
      "Children\u2019s Privacy:",
      "GoldenPeer is not intended for children under 13. We do not knowingly collect data from children. If we learn that we have collected data from a child under 13, we will delete it promptly.",
      "Changes to This Policy:",
      "We may update this Privacy Policy from time to time. We will notify you of material changes through the app and via email. Continued use of GoldenPeer after changes constitutes acceptance of the updated policy.",
  ...
  terms: {
    ...
    content: [
      "Effective Date: January 1, 2025",
      "Welcome to GoldenPeer. By creating an account or using our app, you agree to be bound by these Terms of Service. Please read them carefully.",
      "About GoldenPeer:",
      "GoldenPeer is a voice-guided assistant designed to help seniors aged 65 and older with everyday technology tasks and to protect against scams. It is not a substitute for professional medical, legal, or financial advice.",
      "Your Account:",
      "You must provide accurate and complete information when creating your account. You are responsible for maintaining the confidentiality and security of your login credentials. You must notify us immediately if you suspect unauthorized access to your account. You must be at least 13 years old to use GoldenPeer.",
      "Acceptable Use:",
      "Use GoldenPeer only for its intended purpose of receiving technology help and scam protection. Do not attempt to misuse, reverse engineer, decompile, or interfere with our services. Do not use GoldenPeer to transmit harmful, fraudulent, or illegal content. Do not attempt to access other users\u2019 accounts or data.",
      "Subscriptions and Billing:",
      "GoldenPeer offers a free tier and a paid Pro plan. Pro subscriptions are billed monthly or annually through Stripe, our secure payment processor. All payment information is handled directly by Stripe and is never stored on our servers. You can cancel your subscription at any time from the Settings screen. Refunds are handled on a case-by-case basis \u2014 contact us at the email below.",
      "Intellectual Property:",
      "GoldenPeer, including its name, logo, design, and content, is the property of GoldenPeer and its licensors. You may not copy, modify, distribute, or create derivative works from any part of the app without our written consent.",
      "Data Security and Privacy:",
      "Your use of GoldenPeer is also governed by our Privacy Policy. We use AES-256 encryption for stored data and TLS/SSL for all data in transit. We maintain audit logs of account activity to protect your security.",
      "Limitations and Disclaimers:",
      "GoldenPeer provides general technology guidance and scam detection. We do not guarantee 100% accuracy in scam detection. We are not responsible for actions taken based on our AI assistant\u2019s guidance. The AI assistant will not provide medical, legal, or financial advice \u2014 always consult qualified professionals for those matters. GoldenPeer is provided \u201cas is\u201d without warranties of any kind, express or implied.",
      "Limitation of Liability:",
      "To the maximum extent permitted by law, GoldenPeer shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the app.",
      "Termination:",
  ...
  cookies: {
    ...
    content: [
      "Effective Date: January 1, 2025",
      "GoldenPeer uses minimal cookies and local storage to provide you with a safe and personalized experience. This policy explains what data is stored on your device and why.",
  ...
  security: {
    ...
    content: [
      "Effective Date: January 1, 2025",
      "GoldenPeer takes the security of your data seriously. Below is a comprehensive overview of the security measures we implement to protect your account and personal information.",
      "Encryption:",
      ...
      "If you discover a security vulnerability in GoldenPeer, please report it responsibly by emailing us. We take all reports seriously and will respond promptly. We will not take legal action against researchers who report vulnerabilities in good faith.",
  ...
  contact: {
    ...
    content: [
      ...
      "What to Include:",
      "Your name and the email associated with your GoldenPeer account.",
